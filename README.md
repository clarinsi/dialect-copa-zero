...
| meta-llama/Llama-2-7b-chat-hf | - | - | 0.2 | — | 0.033 | 0.163 | 0.09 | 0.145 | - |
...
Note on bad (still incoming) `meta-llama/Llama-2-7b-chat-hf` performance: it is often indecisive (gives no concrete result), but even when responding, is slightly above the random baseline.
